...
"	    variable Library\n"
#if (TCL_MINOR_VERSION >= 5)
"	    set search [list [pkgconfig get scriptdir,runtime] \\\n"
"		    [pkgconfig get scriptdir,source]]\n"
"	    foreach dir $search {\n"
"		set Library $dir\n"
"		set script [file join $dir " PACKAGE_NAME ".tcl]\n"
"		if {0 == [catch {\n"
"			namespace eval :: [list source $script]\n"
"		} msg]} {\n"
"		    return\n"
"		}\n"
"	    }\n"
